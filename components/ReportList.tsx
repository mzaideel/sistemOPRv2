    ...
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        ...
        <div className="hidden lg:grid grid-cols-12 gap-2 px-6 py-3 bg-slate-50/50 border-b border-slate-100 items-center">
          ...
          <div className="col-span-2 text-[9px] font-black text-slate-400 uppercase tracking-widest text-center">Tarikh</div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 px-6 py-2.5 items-center">
                ...
                <div className="hidden lg:flex col-span-2 justify-center">
                  <span className="text-[11px] font-bold text-slate-500">
                    {new Date(report.date).toLocaleDateString('ms-MY', { day: '2-digit', month: 'short' })}
                  </span>
                </div>
                ...
                <div className="col-span-1 lg:col-span-3 flex items-center justify-end gap-1.5 mt-2 lg:mt-0">
                  <button 
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-900 text-white text-[10px] font-bold rounded-lg hover:bg-blue-600 transition-all active:scale-95 shrink-0"
                  >
                    <span>Papar</span>
                  </button>
                  <button 
